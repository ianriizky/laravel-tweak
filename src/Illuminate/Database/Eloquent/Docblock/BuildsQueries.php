 ...
 * @method static \Ianrizky\Illuminate\Database\Eloquent\Model|object|static|null first(array|string $columns = ['*']) Execute the query and get the first result.
 * @method static mixed|$this when(mixed $value, callable $callback, callable|null $default = null) Apply the callback's query changes if the given "value" is true.
 ...
 * @method static mixed|$this unless(mixed $value, callable $callback, callable|null $default = null) Apply the callback's query changes if the given "value" is false.
 *
